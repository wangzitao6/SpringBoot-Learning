### [23.1 Customizing the Banner](https://docs.spring.io/spring-boot/docs/1.3.7.RELEASE/reference/html/boot-features-spring-application.html#boot-features-banner)
